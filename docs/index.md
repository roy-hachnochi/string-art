...
<div style="text-align: center;">
  <video autoplay muted playsinline preload="auto" style="max-width: 450px; height: auto; border-radius: 8px;">
    <source src="/assets/images/inline/fish_MCBL_string_art.mp4" type="video/mp4">
  </video>
</div>
...
<div class="image-captioned">
  <img src="/assets/images/inline/line_const_vs_AA.jpg" alt="lines" style="max-width:400px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/don_draper_full_vs_low_res.jpg" alt="canvas_res" style="max-width:500px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/don_draper_greedy_string_art.jpg" alt="greedy" style="max-width:250px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/don_draper_LS.jpg" alt="LS" style="max-width:500px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/don_draper_BL_string_art.jpg" alt="BL" style="max-width:250px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/don_draper_weights.jpg" alt="weights" style="max-width:500px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/fish_CMYK.jpg" alt="fish_CMYK" style="max-width:500px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/dithering.jpg" alt="dithering" style="max-width:500px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/multicolor_BL_pipeline.jpg" alt="multicolor_pipeline" style="display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/fish_MCBL_string_art.jpg" alt="fish_MCBL" style="max-width:300px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/fish_MCBL_log.jpg" alt="fish_MCBL_log" style="max-width:500px; display:block; margin:auto; border-radius:10px;">
...
<div class="image-captioned">
  <img src="/assets/images/inline/fish_color_selection.jpg" alt="fish_color_selection" style="max-width:800px; display:block; margin:auto; border-radius:10px;">
...
<div class="glider-contain">
  <div class="glider">
    <div class="hover-effect"><div class="slide"><img src="/assets/images/fish_MCBL_log_string_art.jpg" alt="fish"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/tiger_BL_string_art.jpg" alt="tiger"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/jellyfish_BL_string_art.jpg" alt="jellyfish"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/stag_MCBL_log_string_art.jpg" alt="stag"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/leopard_BL_string_art.jpg" alt="leopard"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/lion_MCBL_log_string_art.jpg" alt="lion"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/fish2_BL_string_art.jpg" alt="fish2"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/fox_BL_string_art.jpg" alt="fox"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/cat2_MCBL_log_string_art.jpg" alt="cat2"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/cat_BL_string_art.jpg" alt="cat"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/eye_BL_string_art.jpg" alt="eye"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/earth_BL_string_art.jpg" alt="earth"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/coraline_MCBL_string_art.jpg" alt="coraline"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/duck_BL_string_art.jpg" alt="duck"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/blade_runner_MCBL_string_art.jpg" alt="blade_runner"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/london_telephone_box_MCBL_log_string_art.jpg" alt="london_telephone_box"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/phoenix_BL_string_art.jpg" alt="phoenix"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/planets_MCBL_log_string_art.jpg" alt="planets"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/snake_MCBL_log_string_art.jpg" alt="snake"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/volcano_BL_string_art.jpg" alt="volcano"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/sauron_BL_string_art.jpg" alt="sauron"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/mona_lisa_MCBL_log_string_art.jpg" alt="mona_lisa"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/bee_MCBL_log_string_art.jpg" alt="bee"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/pink_floyd_BL_string_art.jpg" alt="pink_floyd"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/union_jack_MCBL_log_string_art.jpg" alt="union_jack"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/H_BL_string_art.jpg" alt="H"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/mona_lisa_BW_BL_string_art.jpg" alt="mona_lisa_BW"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/don_draper_BL_w_string_art.jpg" alt="don_draper"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/terminator_BL_string_art.jpg" alt="terminator"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/joker_BL_string_art.jpg" alt="joker"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/walter_white_BL_string_art.jpg" alt="walter_white"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/kill_bill_BL_string_art.jpg" alt="kill_bill"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/morrison_BL_string_art.jpg" alt="morrison"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/godfather_BL_string_art.jpg" alt="godfather"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/gatsby_BL_string_art.jpg" alt="gatsby"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/einstein_BL.jpg" alt="einstein"></div></div>
    <div class="hover-effect"><div class="slide"><img src="/assets/images/pulp_fiction_BL_string_art.jpg" alt="pulp_fiction"></div></div>
  </div>
